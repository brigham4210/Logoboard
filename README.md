...
### 🎨 Key Customization
- **Double-click any key** to upload a custom image
- **Right-click any key** to reset it to default
- Images are stored in browser localStorage and persist across sessions
...
- **Double-click topic**: Rename the topic

## Live Demo

View the live version at: [https://brigham4210.github.io/Logoboard/](https://brigham4210.github.io/Logoboard/)

## Technologies Used

- **HTML5**: Structure and markup
- **CSS3**: Styling with modern effects (backdrop-filter, gradients, transitions)
- **Vanilla JavaScript**: All functionality with no frameworks
